 ...
 * 
 * 컴파일: g++ -std=c++17 -o 04_parameter_by_reference 04_parameter_by_reference.cpp
 * 실행: ./04_parameter_by_reference (Linux/Mac) 또는 04_parameter_by_reference.exe (Windows)
 */
