...
## 18. 예제 18: nullptr과 안전성 (18_nullptr_safety.cpp)
...
## 19. 예제 19: unique_ptr 기초 (19_unique_ptr.cpp)
...
## 20. 예제 20: shared_ptr 기초 (20_shared_ptr.cpp)
...
### 과제 1: 간단한 계산기
두 숫자와 연산자를 입력받아 계산하는 프로그램 (switch 사용)

### 과제 2: 구구단 출력기
사용자가 입력한 단의 구구단을 출력 (for 사용)

### 과제 3: 숫자 맞히기 게임
1-10 사이 숫자를 맞히는 게임 (while, if 사용)

### 과제 4: 동적 배열 평균 계산
사용자가 입력한 개수만큼 숫자를 저장하고 평균 계산 (스마트 포인터 사용)
